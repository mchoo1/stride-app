...
export const SG_RESTAURANTS: SGRestaurant[] = [
  ...
  // ── A&W ──────────────────────────────────────────────────────────────────
  {
    ...
    outletType: 'grab_go',
    serviceTypes: ['dine_in', 'grab_go'],
    aliases: ['a&w', 'a and w', 'aw'],
    dietTags: ['halal'],
    priceRange: '$',
    nutritionUrl: 'https://www.aw.com.sg/menu/',
    lastUpdated: '2026-05-13',
    menu: [
      { id: 'aw_mozza_burger', name: 'Mozza Burger', emoji: '🍔', price: 7.95, calories: 480, protein: 24, carbs: 45, fat: 22, category: 'Burgers', compatibleWith: ['halal'], isPopular: true, source: 'community', verified: false, confidence: 'estimated', lastVerified: '2026-05-13' },
      { id: 'aw_chicken_waffle', name: 'Chicken Waffle', emoji: '🧇', price: 8.50, calories: 560, protein: 28, carbs: 55, fat: 24, category: 'Signatures', compatibleWith: ['halal'], isPopular: true, source: 'community', verified: false, confidence: 'estimated', lastVerified: '2026-05-13' },
      { id: 'aw_curly_fries_m', name: 'Curly Fries (M)', emoji: '🍟', price: 4.50, calories: 380, protein: 5, carbs: 48, fat: 18, category: 'Sides', compatibleWith: ['halal', 'vegetarian'], isPopular: true, source: 'community', verified: false, confidence: 'estimated', lastVerified: '2026-05-13' },
      { id: 'aw_coney_dog', name: 'Coney Dog', emoji: '🌭', price: 5.50, calories: 310, protein: 13, carbs: 30, fat: 16, category: 'Signatures', compatibleWith: ['halal'], isPopular: true, source: 'community', verified: false, confidence: 'estimated', lastVerified: '2026-05-13' },
      { id: 'aw_onion_rings', name: 'Onion Rings (Reg)', emoji: '🧅', price: 4.20, calories: 340, protein: 4, carbs: 42, fat: 17, category: 'Sides', compatibleWith: ['halal', 'vegetarian'], isPopular: false, source: 'community', verified: false, confidence: 'estimated', lastVerified: '2026-05-13' },
      { id: 'aw_root_beer_float', name: 'Root Beer Float', emoji: '🥤', price: 4.00, calories: 290, protein: 3, carbs: 58, fat: 5, category: 'Drinks', compatibleWith: ['halal', 'vegetarian'], isPopular: true, source: 'community', verified: false, confidence: 'estimated', lastVerified: '2026-05-13' },
      { id: 'aw_grilled_chicken', name: 'Grilled Chicken Burger', emoji: '🍗', price: 7.50, calories: 380, protein: 30, carbs: 32, fat: 14, category: 'Burgers', compatibleWith: ['halal'], isPopular: false, source: 'community', verified: false, confidence: 'estimated', lastVerified: '2026-05-13' },
    ],
  },
  ...
  // ── Jollibee ──────────────────────────────────────────────────────────────
  {
    ...
    dietTags: ['halal'],
    priceRange: '$',
    nutritionUrl: 'https://www.jollibee.com.sg/menu/',
    lastUpdated: '2026-05-13',
    menu: [
      { id: 'jb_chickenjoy_1pc', name: 'Chickenjoy (1 pc)', emoji: '🍗', price: 5.90, calories: 430, protein: 30, carbs: 18, fat: 28, category: 'Chicken', compatibleWith: ['halal'], isPopular: true, source: 'community', verified: false, confidence: 'estimated', lastVerified: '2026-05-13' },
      { id: 'jb_chickenjoy_2pc', name: 'Chickenjoy (2 pc)', emoji: '🍗', price: 10.50, calories: 860, protein: 60, carbs: 36, fat: 56, category: 'Chicken', compatibleWith: ['halal'], isPopular: false, source: 'community', verified: false, confidence: 'estimated', lastVerified: '2026-05-13' },
      { id: 'jb_jolly_spaghetti', name: 'Jolly Spaghetti', emoji: '🍝', price: 5.20, calories: 490, protein: 18, carbs: 72, fat: 14, category: 'Pasta', compatibleWith: ['halal'], isPopular: true, source: 'community', verified: false, confidence: 'estimated', lastVerified: '2026-05-13' },
      { id: 'jb_yum_burger', name: 'Yum Burger', emoji: '🍔', price: 3.90, calories: 310, protein: 15, carbs: 30, fat: 14, category: 'Burgers', compatibleWith: ['halal'], isPopular: false, source: 'community', verified: false, confidence: 'estimated', lastVerified: '2026-05-13' },
      { id: 'jb_peach_mango_pie', name: 'Peach Mango Pie', emoji: '🥧', price: 2.20, calories: 230, protein: 3, carbs: 33, fat: 10, category: 'Desserts', compatibleWith: ['halal', 'vegetarian'], isPopular: true, source: 'community', verified: false, confidence: 'estimated', lastVerified: '2026-05-13' },
      { id: 'jb_crispy_chicken_sandwich', name: 'Crispy Chicken Sandwich', emoji: '🥪', price: 6.50, calories: 440, protein: 26, carbs: 42, fat: 18, category: 'Burgers', compatibleWith: ['halal'], isPopular: true, source: 'community', verified: false, confidence: 'estimated', lastVerified: '2026-05-13' },
      { id: 'jb_jolly_fries', name: 'Jolly Fries (Reg)', emoji: '🍟', price: 3.50, calories: 310, protein: 4, carbs: 40, fat: 15, category: 'Sides', compatibleWith: ['halal', 'vegetarian'], isPopular: false, source: 'community', verified: false, confidence: 'estimated', lastVerified: '2026-05-13' },
    ],
  },
  ...
  // ── Toast Box ─────────────────────────────────────────────────────────────
  {
    ...
    name: 'Toast Box',
    emoji: '🍞',
    cuisine: 'Singaporean Kaya Toast / Kopi',
    tab: 'grab_go',
    tier: 'chain',
    outletType: 'grab_go',
    serviceTypes: ['dine_in', 'grab_go'],
    aliases: ['toast box', 'toastbox'],
    dietTags: ['halal'],
    priceRange: '$',
    nutritionUrl: 'https://www.toastbox.com.sg/menu/',
    lastUpdated: '2026-05-13',
    menu: [
      { id: 'tb_kaya_butter_toast', name: 'Kaya Butter Toast (2 slices)', emoji: '🍞', price: 2.50, calories: 220, protein: 5, carbs: 28, fat: 10, category: 'Toast', compatibleWith: ['vegetarian', 'halal'], isPopular: true, source: 'community', verified: false, confidence: 'estimated', lastVerified: '2026-05-13' },
      { id: 'tb_soft_boiled_eggs', name: 'Soft Boiled Eggs (2 pcs)', emoji: '🥚', price: 2.00, calories: 124, protein: 11, carbs: 1, fat: 9, category: 'Eggs', compatibleWith: ['vegetarian', 'halal', 'gluten_free', 'keto'], isPopular: true, source: 'community', verified: false, confidence: 'estimated', lastVerified: '2026-05-13' },
      { id: 'tb_kopi_o', name: 'Kopi O', emoji: '☕', price: 1.80, calories: 40, protein: 0, carbs: 8, fat: 0, category: 'Drinks', compatibleWith: ['halal', 'vegetarian', 'vegan', 'gluten_free'], isPopular: true, source: 'community', verified: false, confidence: 'estimated', lastVerified: '2026-05-13' },
      { id: 'tb_milo_dinosaur', name: 'Milo Dinosaur', emoji: '🥤', price: 4.00, calories: 280, protein: 7, carbs: 48, fat: 5, category: 'Drinks', compatibleWith: ['halal', 'vegetarian'], isPopular: true, source: 'community', verified: false, confidence: 'estimated', lastVerified: '2026-05-13' },
      { id: 'tb_nasi_lemak', name: 'Nasi Lemak Set', emoji: '🍚', price: 5.80, calories: 480, protein: 18, carbs: 62, fat: 18, category: 'Rice', compatibleWith: ['halal'], isPopular: false, source: 'community', verified: false, confidence: 'estimated', lastVerified: '2026-05-13' },
      { id: 'tb_chicken_macaroni', name: 'Chicken Macaroni Soup', emoji: '🍜', price: 4.80, calories: 320, protein: 22, carbs: 40, fat: 7, category: 'Noodles', compatibleWith: ['halal'], isPopular: false, source: 'community', verified: false, confidence: 'estimated', lastVerified: '2026-05-13' },
      { id: 'tb_french_toast', name: 'French Toast', emoji: '🍳', price: 3.20, calories: 280, protein: 8, carbs: 35, fat: 12, category: 'Toast', compatibleWith: ['vegetarian', 'halal'], isPopular: false, source: 'community', verified: false, confidence: 'estimated', lastVerified: '2026-05-13' },
    ],
  },
  ...
  // ── LiHo Tea ─────────────────────────────────────────────────────────────
  {
    ...
    dietTags: ['halal', 'vegetarian'],
    priceRange: '$',
    nutritionUrl: 'https://www.liho.com.sg/menu/',
    lastUpdated: '2026-05-13',
    menu: [
      { id: 'liho_brown_sugar_boba_m', name: 'Brown Sugar Boba Milk (M)', emoji: '🧋', price: 5.50, calories: 380, protein: 5, carbs: 68, fat: 9, category: 'Milk Tea', compatibleWith: ['halal', 'vegetarian'], isPopular: true, source: 'community', verified: false, confidence: 'estimated', lastVerified: '2026-05-13' },
      { id: 'liho_cheese_tea_m', name: 'Cheese Tea (M)', emoji: '🧋', price: 5.80, calories: 280, protein: 7, carbs: 38, fat: 11, category: 'Cheese Tea', compatibleWith: ['halal', 'vegetarian'], isPopular: true, source: 'community', verified: false, confidence: 'estimated', lastVerified: '2026-05-13' },
      { id: 'liho_oolong_m', name: 'Roasted Oolong (M)', emoji: '🍵', price: 3.80, calories: 80, protein: 0, carbs: 18, fat: 0, category: 'Pure Tea', compatibleWith: ['halal', 'vegetarian', 'vegan', 'gluten_free', 'keto'], isPopular: false, source: 'community', verified: false, confidence: 'estimated', lastVerified: '2026-05-13' },
      { id: 'liho_taro_milk_tea_m', name: 'Taro Milk Tea (M)', emoji: '🧋', price: 5.20, calories: 310, protein: 4, carbs: 55, fat: 8, category: 'Milk Tea', compatibleWith: ['halal', 'vegetarian'], isPopular: true, source: 'community', verified: false, confidence: 'estimated', lastVerified: '2026-05-13' },
      { id: 'liho_zero_sugar_m', name: 'Zero Sugar Milk Tea (M)', emoji: '🧋', price: 4.80, calories: 85, protein: 3, carbs: 10, fat: 3, category: 'Milk Tea', compatibleWith: ['halal', 'vegetarian', 'keto'], isPopular: false, source: 'community', verified: false, confidence: 'estimated', lastVerified: '2026-05-13' },
      { id: 'liho_matcha_latte_m', name: 'Matcha Latte (M)', emoji: '🍵', price: 5.50, calories: 230, protein: 5, carbs: 38, fat: 7, category: 'Special', compatibleWith: ['halal', 'vegetarian'], isPopular: false, source: 'community', verified: false, confidence: 'estimated', lastVerified: '2026-05-13' },
    ],
  },
  ...
  // ── Cheers ────────────────────────────────────────────────────────────────
  {
    ...
    outletType: 'ready_to_eat',
    serviceTypes: ['grab_go'],
    aliases: ['cheers', 'cheers fairprice'],
    dietTags: ['halal'],
    priceRange: '$',
    nutritionUrl: 'https://www.cheers.com.sg/',
    lastUpdated: '2026-05-13',
    menu: [
      { id: 'cheers_onigiri_tuna', name: 'Tuna Mayo Onigiri', emoji: '🍙', price: 2.50, calories: 195, protein: 8, carbs: 32, fat: 4, category: 'Onigiri', compatibleWith: ['halal'], isPopular: true, source: 'community', verified: false, confidence: 'estimated', lastVerified: '2026-05-13' },
      { id: 'cheers_onigiri_chicken', name: 'Teriyaki Chicken Onigiri', emoji: '🍙', price: 2.50, calories: 210, protein: 10, carbs: 32, fat: 5, category: 'Onigiri', compatibleWith: ['halal'], isPopular: false, source: 'community', verified: false, confidence: 'estimated', lastVerified: '2026-05-13' },
      { id: 'cheers_chicken_pie', name: 'Hot Chicken Pie', emoji: '🥧', price: 2.80, calories: 290, protein: 11, carbs: 30, fat: 14, category: 'Hot Food', compatibleWith: ['halal'], isPopular: true, source: 'community', verified: false, confidence: 'estimated', lastVerified: '2026-05-13' },
      { id: 'cheers_hard_boiled_eggs', name: 'Hard Boiled Eggs (2 pcs)', emoji: '🥚', price: 1.50, calories: 124, protein: 11, carbs: 1, fat: 9, category: 'Snacks', compatibleWith: ['halal', 'vegetarian', 'gluten_free', 'keto'], isPopular: false, source: 'community', verified: false, confidence: 'estimated', lastVerified: '2026-05-13' },
      { id: 'cheers_chicken_wrap', name: 'Grilled Chicken Wrap', emoji: '🌯', price: 4.50, calories: 340, protein: 22, carbs: 38, fat: 10, category: 'Hot Food', compatibleWith: ['halal'], isPopular: true, source: 'community', verified: false, confidence: 'estimated', lastVerified: '2026-05-13' },
      { id: 'cheers_greek_yogurt', name: 'Greek Yogurt (plain)', emoji: '🥛', price: 3.20, calories: 130, protein: 12, carbs: 9, fat: 3, category: 'Dairy', compatibleWith: ['halal', 'vegetarian', 'gluten_free', 'keto'], isPopular: false, source: 'community', verified: false, confidence: 'estimated', lastVerified: '2026-05-13' },
      { id: 'cheers_protein_bar', name: 'Protein Bar (Quest/similar)', emoji: '🍫', price: 4.50, calories: 190, protein: 20, carbs: 22, fat: 7, category: 'Snacks', compatibleWith: ['halal', 'gluten_free'], isPopular: true, source: 'community', verified: false, confidence: 'estimated', lastVerified: '2026-05-13' },
    ],
  },
];
