...
const STEPS = ['Goal', 'Body', 'Diet', 'Done'];
...
export default function OnboardingPage() {
  ...
  const finish = () => { completeOnboarding(data); router.push('/dashboard'); };
      ...
      <div style={{ flex: 1, maxWidth: 440, width: '100%', margin: '0 auto', padding: '24px 20px 40px' }}>
        ...
        {step === 2 && (
          <div className="animate-fade-in">
            ...
            <p style={{ fontSize: 14, color: '#888', marginBottom: 24 }}>
              Select any that apply — we&apos;ll filter meal recommendations for you.
            </p>
        ...
        {/* ── Step 3: Done ── */}
        {step === 3 && (
          <div className="animate-fade-in" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', paddingTop: 24 }}>
            <div style={{
            ...
            <div style={{
              ...
              <div className="section-label" style={{ marginBottom: 12 }}>Your daily targets</div>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10 }}>
                {[
                  { l: 'Goal', v: data.goalType === 'weight_loss' ? '📉 Lose Weight' : data.goalType === 'muscle_gain' ? '💪 Build Muscle' : '⚖️ Maintain', c: '#4CAF82' },
            ...
            <button onClick={finish} className="btn-primary" style={{ width: '100%', padding: '14px 0', fontSize: 16 }}>
              🚀 Start Tracking
            </button>
          </div>
        )}
